import 'package:chuva_dart/app/app_module.dart';
import 'package:flutter/material.dart';

import 'app/data/http/http_client.dart';
import 'app/data/repositories/event_repository.dart';
import 'app/modules/home_module/home_screen.dart';
import 'app/modules/home_module/home_store.dart';

void main() {
 // final EventStore _store = EventStore(repository: EventRepository(client: HttpClient()));
